function CopDamage:check_decapitations( damage_data )
	...
	if self._dead then
		if MeleeOverhaul:HasSetting( "TrueDecapitation" ) and ( not MeleeOverhaul:HasSetting( "RealisticGore" ) or ( MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) == "LargeBladed" ) ) then
			if head then
		...
		if MeleeOverhaul:HasSetting( "TrueDecapitation" ) and ( not MeleeOverhaul:HasSetting( "RealisticGore" ) or ( MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) == "Blunt" ) ) then
			if head then
		...
		if head and not self._decapitated then
			...
			if not MeleeOverhaul:HasSetting( "RealisticGore" ) or ( MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) == "LargeBladed" ) then
				self._unit:sound():play( "split_gen_head" )
				...
				self._unit:movement():add_dismemberment( "Head" , MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) )
			end
			if MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) == "SmallBladed" then
				self._unit:sound():play( "split_gen_head" )
				self._unit:movement():add_dismemberment( "Head" , MeleeOverhaul:MeleeType( melee_entry ) )
			end
			if MeleeOverhaul:HasSetting( "RealisticGore" ) and MeleeOverhaul:MeleeType( melee_entry ) == "Blunt" then
...
function CopDamage:check_blunt_force( damage_data )
	...
	if damage_data.death and head and MeleeOverhaul:MeleeType( melee_entry ) == "Blunt" and not managers.groupai:state():whisper_mode() then
		self._unit:movement():enable_update()
		self._unit:movement()._frozen = nil
